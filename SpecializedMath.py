...
def SpecializedMath():
    ...
    Button(math, text="Calculator", command=None, height=1, width=6). \
        grid(row=1, column=0, padx=20, pady=20, ipadx=40, ipady=40)

    Button(math, text="Calculator", command=None, height=1, width=6). \
        grid(row=1, column=1, padx=20, pady=20, ipadx=40, ipady=40)
